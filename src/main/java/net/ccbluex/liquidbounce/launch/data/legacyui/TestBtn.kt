...
class TestBtn : GuiButton {
    ...
    override fun drawButton(mc: Minecraft, mouseX: Int, mouseY: Int) {
        ...
        RenderUtils.drawRoundedCornerRect(
            ...
            if (image != null) width.toFloat()/2 else 2f, if(FDPClient.Darkmode) Color(255,255,255, 30).rgb else Color(0,0,0, 70).rgb
        )
        RenderUtils.drawRoundedCornerRect(
            xPosition.toFloat()-0.5f, yPosition.toFloat()-0.5f + yOffset, (xPosition + width).toFloat()+0.5f, (
                    yPosition + height).toFloat()+0.5f + yOffset, if (image != null) width.toFloat()/2 else 3f, if(FDPClient.Darkmode) Color(255,255,255, 110+(wi*10)).rgb else  Color(0,0,0, 120+(wi*10)).rgb
        )
        RenderUtils.drawRoundedCornerRect(
            xPosition.toFloat(), yPosition.toFloat() + yOffset, (xPosition + width).toFloat(), (
                    yPosition + height).toFloat() + yOffset, if (image != null) width.toFloat()/2 else 3f,if(FDPClient.Darkmode) Color(255,255,255, 80).rgb else Color(0,0,0, 50).rgb
        )
        ...
        if (image != null) {
            if(this.isMouseOver) {
                ...
                RenderUtils.drawRoundedCornerRect(
                    ...
                    3f,
                    if(FDPClient.Darkmode) Color(255, 255, 255, (150*percent).toInt()).rgb else Color(0, 0, 0, (150*percent).toInt()).rgb
                )
                FontLoaders.C16.DisplayFonts(
                    ...
                    if(FDPClient.Darkmode) Color(50, 50, 50, (254*percent).toInt()).rgb else Color(180, 180, 180, (254*percent).toInt()).rgb,FontLoaders.C16
                )
            }
        }else{
            ...
            val s = font.DisplayFonts(
                ...
                xPosition + width / 2 - (font.DisplayFontWidths(displayString,font) / 2).toFloat(), (
                        yPosition + height / 2 - 4).toFloat() + yOffset, if(FDPClient.Darkmode) Color(50, 50, 50, 255).rgb else  Color(180, 180, 180, 255).rgb,FontLoaders.C16
            )
        }
        GL11.glPopAttrib()
        GL11.glPopMatrix()
