 ...
 */
package net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.style.styles.light;

import java.awt.*;
import java.io.IOException;

import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.style.styles.light.LightSettings.InputBox;
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.style.styles.light.ModuleSettings.Setting.Settings;
