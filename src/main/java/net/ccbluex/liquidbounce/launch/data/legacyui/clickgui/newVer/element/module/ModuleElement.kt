package net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer.element.module

import net.ccbluex.liquidbounce.features.module.Module
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer.ColorManager
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer.element.components.ToggleSwitch
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer.element.module.value.ValueElement
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer.element.module.value.impl.BooleanElement
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer.element.module.value.impl.ListElement
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer.element.module.value.impl.IntElement
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer.element.module.value.impl.FloatElement
...
open class ModuleElement(val module: Module): MinecraftInstance() {
    ...
    companion object {
        protected val expandIcon = ResourceLocation("fdpclient/expand.png") }
    ...
    fun handleKeyTyped(typed: Char, code: Int) {
        if (listeningToKey) {
            if (code == 1) {
                module.keyBind = 0
