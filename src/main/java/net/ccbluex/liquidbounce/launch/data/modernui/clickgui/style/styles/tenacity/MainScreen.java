 ...
 */
package net.ccbluex.liquidbounce.launch.data.modernui.clickgui.style.styles.tenacity;
...
import net.ccbluex.liquidbounce.launch.data.modernui.clickgui.style.styles.tenacity.impl.ModuleRect;
...
import net.ccbluex.liquidbounce.launch.data.modernui.clickgui.utils.animations.impl.DecelerateAnimation;
import net.ccbluex.liquidbounce.launch.data.modernui.clickgui.utils.normal.Main;
import net.ccbluex.liquidbounce.launch.data.modernui.clickgui.utils.normal.Screen;
import net.ccbluex.liquidbounce.launch.data.modernui.clickgui.utils.render.DrRenderUtils;
import net.ccbluex.liquidbounce.launch.data.modernui.clickgui.utils.render.StencilUtil;
...
import static net.ccbluex.liquidbounce.launch.data.modernui.clickgui.utils.render.DrRenderUtils.isHovering;
