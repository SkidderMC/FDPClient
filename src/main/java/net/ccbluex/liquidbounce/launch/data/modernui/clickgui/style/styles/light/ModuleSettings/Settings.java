 ...
 */
package net.ccbluex.liquidbounce.launch.data.modernui.clickgui.style.styles.light.ModuleSettings;
...
public class Settings extends Setting {
    ...
    public void drawBoolValue(boolean mouse,int mouseX,int mouseY,float startX,float mY,BoolValue boolValue) {
        ...
        RenderUtils.circle(x + 40 + boolValue.getAnimation().getAnimationX(), mY + 3, 4, boolValue.get() ? new Color(255,255,255,alphaAnim.getAlpha()).getRGB() : new Color(66, 134, 245,alphaAnim.getAlpha()).getRGB());
        if (boolValue.get()) {
