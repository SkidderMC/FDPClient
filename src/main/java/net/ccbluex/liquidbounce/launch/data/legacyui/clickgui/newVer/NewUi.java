package net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer;

import net.ccbluex.liquidbounce.features.module.ModuleCategory;
import net.ccbluex.liquidbounce.features.module.modules.client.NewGUI;
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer.element.CategoryElement;
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer.element.SearchElement;
import net.ccbluex.liquidbounce.launch.data.legacyui.clickgui.newVer.element.module.ModuleElement;
