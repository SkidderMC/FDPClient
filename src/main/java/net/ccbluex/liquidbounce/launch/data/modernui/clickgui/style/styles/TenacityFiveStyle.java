...
public class TenacityFiveStyle extends Style {
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        if(moduleElement.getModule().getState() == true){
                    Gui.drawRect(moduleElement.getX() + 2, moduleElement.getY(), moduleElement.getX() + moduleElement.getWidth() -2, moduleElement.getY() + moduleElement.getHeight(), hoverColor(new Color(0,0,0,30), moduleElement.hoverTime).getRGB());
        } else {
