...
public class TenacityFiveStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
      // top RenderUtils.drawBorderedRect((float) panel.getX(), (float) panel.getY() - 3, (float) panel.getX() + panel.getWidth(), (float) panel.getY() + 17, 3, new Color(217, 217, 217).getRGB(), new Color(217, 217, 217).getRGB());
        RenderUtils.drawGradientRoundedRect( panel.getX(), panel.getY() + 17, panel.getX() + panel.getWidth(), panel.getY() + 19 + panel.getFade(), 3, new Color(241,135,251).getRGB(), new Color(67,156,251).getRGB()); 
