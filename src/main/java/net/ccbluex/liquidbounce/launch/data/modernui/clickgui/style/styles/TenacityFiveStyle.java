...
public class TenacityFiveStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        if (panel.getFade() > 0) {
        RenderUtils.customRounded((float) panel.getX() + 3, (float) panel.getY() + 15 + panel.getFade(), (float) panel.getX() + panel.getWidth() - 3, (float) panel.getY() + 20 + panel.getFade() + 5, 0f, 0f, 7, 7, new Color(33, 33, 33).getRGB());
