...
public class JelloStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        ...
        FontLoaders.SF35.DisplayFont(FontLoaders.SF35, "  " + LanguageManager.INSTANCE.get(panel.getName().replaceAll("%","")), panel.getX() + 10, panel.getY() - 7, new Color(116,114,115).getRGB());
    }
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        if(moduleElement.getModule().getState() == true){
            FontLoaders.SF25.DisplayFont(FontLoaders.SF25, "   " + LanguageManager.INSTANCE.get(moduleElement.getDisplayName().replaceAll("%","")), moduleElement.getX() + 5, moduleElement.getY() + 5, Color.WHITE.getRGB());
        } else {
            FontLoaders.SF25.DisplayFont(FontLoaders.SF25,"  " + LanguageManager.INSTANCE.get(moduleElement.getDisplayName().replaceAll("%","")), moduleElement.getX() + 5, moduleElement.getY() + 5, Color.BLACK.getRGB());
        }
