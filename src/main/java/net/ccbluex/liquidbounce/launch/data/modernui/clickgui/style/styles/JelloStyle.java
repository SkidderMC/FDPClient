...
public class JelloStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        RenderUtils.quickDrawRect((float) panel.getX(), (float) panel.getY() - 3, (float) panel.getX() + panel.getWidth(), (float) panel.getY() + 17, 3, new Color(250, 250, 250).getRGB());
        if (panel.getFade() > 0) {
            RenderUtils.quickDrawRect((float) panel.getX(), (float) panel.getY() + 17, (float) panel.getX() + panel.getWidth(), panel.getY() + 19 + panel.getFade(), 3, new Color(250, 250, 250).getRGB());
