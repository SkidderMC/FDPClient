...
public class JelloStyle extends Style {
    ...
    public void drawPanel(int mouseX, int mouseY, Panel panel) {
        ...
        FontLoaders.SF40.DisplayFont(FontLoaders.SF40, "  " + LanguageManager.INSTANCE.get(panel.getName().replaceAll("%","")), panel.getX() + 10, panel.getY(), new Color(116,114,115).getRGB());
    }
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        if(moduleElement.getModule().getState() == true){
            FontLoaders.SF30.DisplayFont(FontLoaders.SF30, "   " + LanguageManager.INSTANCE.get(moduleElement.getDisplayName().replaceAll("%","")), moduleElement.getX() + 5, moduleElement.getY() + 5, Color.WHITE.getRGB());
        } else {
            FontLoaders.SF30.DisplayFont(FontLoaders.SF30,"  " + LanguageManager.INSTANCE.get(moduleElement.getDisplayName().replaceAll("%","")), moduleElement.getX() + 5, moduleElement.getY() + 5, Color.BLACK.getRGB());
        }
