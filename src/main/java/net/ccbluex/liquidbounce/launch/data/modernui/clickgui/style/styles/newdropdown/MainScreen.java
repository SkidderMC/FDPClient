...
import net.ccbluex.liquidbounce.launch.data.modernui.clickgui.style.styles.newdropdown.impl.ModuleRect;
...
import net.ccbluex.liquidbounce.launch.data.modernui.clickgui.style.styles.newdropdown.utils.normal.Screen;
import net.ccbluex.liquidbounce.launch.data.modernui.clickgui.style.styles.newdropdown.utils.render.DrRenderUtils;
import net.ccbluex.liquidbounce.launch.data.modernui.clickgui.style.styles.newdropdown.utils.render.StencilUtil;
...
import static net.ccbluex.liquidbounce.launch.data.modernui.clickgui.style.styles.newdropdown.utils.render.DrRenderUtils.isHovering;
