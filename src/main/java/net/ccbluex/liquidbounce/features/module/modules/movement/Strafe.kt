...
object Strafe : Module() {
    ...
    private var onGroundStrafeValue = BoolValue("OnGroundStrafe", true)
    private val inAirStrafeValue = BoolValue("InAirStrafe", true)
    ...
    fun onStrafe(event: StrafeEvent) {
        ...
        if ((mc.thePlayer.onGround && onGroundStrafeValue.get()) || (!mc.thePlayer.onGround && inAirStrafeValue.get())) {
