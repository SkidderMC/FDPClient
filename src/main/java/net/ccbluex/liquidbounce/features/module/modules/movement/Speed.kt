...
object Speed : Module("Speed", Category.MOVEMENT, Category.SubCategory.MOVEMENT_MAIN) {
    ...
    //FastFall Speed
    val fastFallBoostMode by choices("FastFallBoostMode", arrayOf("Simple",     "Motion"), "Simple") { mode.get() == "FastFall" }
    val fastFallBoostSimple by float("FastFallBoostSimple", 2f, 1f..10f) { mode.get() == "FastFall" && fastFallBoostMode == "Simple" }
    ...
    get() = modeModule in arrayOf(Legit, FastFall)
}
