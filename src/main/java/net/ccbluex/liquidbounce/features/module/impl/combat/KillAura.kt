 ...
 */
package net.ccbluex.liquidbounce.features.module.impl.combat
...
import net.ccbluex.liquidbounce.features.module.impl.movement.Flight
import net.ccbluex.liquidbounce.features.module.impl.movement.StrafeFix
import net.ccbluex.liquidbounce.features.module.impl.movement.TargetStrafe
import net.ccbluex.liquidbounce.features.module.impl.player.Blink
import net.ccbluex.liquidbounce.features.module.impl.visual.FreeCam
import net.ccbluex.liquidbounce.features.module.impl.world.Scaffold
...
object KillAura : Module() {
    ...
    val targetModeValue = ListValue("TargetMode", arrayOf("Single", "Switch", "Multi"), "Switch").displayable { rotationDisplay.get() }
