...
object Animations : Module() {
    val blockingModeValue = ListValue(
        "BlockingMode", arrayOf("PushFall", "Akrien", "Avatar", "ETB", "Exhibition", "Push", "Reverse", "Shield", "SigmaNew", "SigmaOld", "Slide", "SlideDown", "HSlide", "Swong", "VisionFX", "Swank", "Jello", "Rotate", "Liquid", "Fall", "Yeet", "Yeet2", "None"), "Rotate")
