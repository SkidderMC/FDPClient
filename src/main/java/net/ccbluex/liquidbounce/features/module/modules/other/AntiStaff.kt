...
object AntiStaff : Module() {
    ...
    private var minelatinoStaff : String = "zycragames _Dryout BunnyTruckSo amaelarco Norstonta Unexpected 1x12 Frachiza BabasTheBoring dhoslamarstack Bartolo_MC Ferris"
