 ...
 */
package net.ccbluex.liquidbounce.features.module.impl.movement.speeds.aac

import net.ccbluex.liquidbounce.FDPClient
import net.ccbluex.liquidbounce.event.JumpEvent
import net.ccbluex.liquidbounce.features.module.impl.movement.speeds.SpeedMode
    ...
    override fun onUpdate() {
        ...
        when {
            (mc.thePlayer.onGround && mc.thePlayer.isCollidedVertically) -> {
                ...
                FDPClient.eventManager.callEvent(JumpEvent(0.405f))
