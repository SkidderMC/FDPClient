...
public class KillESP extends Module {
	...
	private final NumberValue speed = new NumberValue("Zavz-Speed", 0.1d, 0.0d, 10.0d, 0.1d);
	...
	private void renderZavzMode(Render3DEvent event) {
			...
			for (int i = 0; i <= precision; i++) {
				...
				RenderUtils.glColor(Objects.requireNonNull(ColorUtils.getGradientOffset(Objects.requireNonNull(FDPClient.moduleManager.get(ColorManager.class)).getColor1(), FDPClient.moduleManager.get(ColorManager.class).getColor2(), Math.abs(System.currentTimeMillis() / 10L) / 100.0 + y)));
			...
			if (dual.get()) {
				...
				for (int i = 0; i <= precision; i++) {
					...
					RenderUtils.glColor(Objects.requireNonNull(ColorUtils.getGradientOffset(Objects.requireNonNull(Objects.requireNonNull(FDPClient.moduleManager.get(ColorManager.class))).getColor1(), Objects.requireNonNull(FDPClient.moduleManager.get(ColorManager.class)).getColor2(), Math.abs(System.currentTimeMillis() / 10L) / 100.0 + y)));
