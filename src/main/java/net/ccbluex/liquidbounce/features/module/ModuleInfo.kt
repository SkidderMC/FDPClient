...
annotation class ModuleInfo(val name: String, val category: ModuleCategory,
                            ...
                            val defaultOn: Boolean = false, val triggerType: EnumTriggerType = EnumTriggerType.TOGGLE)
