...
object DiscordRPC {
    ...
    private var fdpwebsite = "DG636 Moment - "
    ...
    private fun update() {
        ...
        builder.setLargeImage(if (discordRPCModule.animated.get()){"https://fdpinfo.github.io/DG636/fdp.gif"} else {"https://fdpinfo.github.io/DG636/fdp.gif"}, "$CLIENT_NAME $CLIENT_VERSION")
