...
object DiscordRPC {
    ...
    private fun update() {
        ...
        builder.setLargeImage(if (discordRPCModule.gato.get()) {"https://fdpinfo.github.io/DG636/fdp.gif"} else { if (discordRPCModule.animated.get()){"https://skiddermc.github.io/repo/skiddermc/FDPclient/dcrpc/fdp.gif"} else {"https://skiddermc.github.io/repo/skiddermc/FDPclient/dcrpc/fdp.png"}}, "$CLIENT_NAME $CLIENT_VERSION")
