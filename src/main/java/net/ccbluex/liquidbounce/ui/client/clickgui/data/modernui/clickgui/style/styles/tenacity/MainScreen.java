 ...
 */
package net.ccbluex.liquidbounce.ui.client.clickgui.data.modernui.clickgui.style.styles.tenacity;
...
import net.ccbluex.liquidbounce.ui.client.clickgui.data.modernui.clickgui.style.styles.tenacity.impl.ModuleRect;
import net.ccbluex.liquidbounce.ui.client.clickgui.data.modernui.clickgui.utils.animations.Animation;
import net.ccbluex.liquidbounce.ui.client.clickgui.data.modernui.clickgui.utils.animations.Direction;
import net.ccbluex.liquidbounce.ui.client.clickgui.data.modernui.clickgui.utils.animations.impl.DecelerateAnimation;
import net.ccbluex.liquidbounce.ui.client.clickgui.data.modernui.clickgui.utils.normal.Main;
import net.ccbluex.liquidbounce.ui.client.clickgui.data.modernui.clickgui.utils.normal.Screen;
import net.ccbluex.liquidbounce.ui.client.clickgui.data.modernui.clickgui.utils.render.DrRenderUtils;
import net.ccbluex.liquidbounce.ui.client.clickgui.data.modernui.clickgui.utils.render.StencilUtil;
...
import static net.ccbluex.liquidbounce.ui.client.clickgui.data.modernui.clickgui.utils.render.DrRenderUtils.isHovering;
