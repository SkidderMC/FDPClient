...
class GuiBackground(private val prevGui: GuiScreen) : GuiScreen() {
    ...
    override fun initGui() {
        ...
        buttonList.add(GuiButton(3, width / 2 - 100, height / 4 + 40 + 25 * 5, 98, 20, "Change wallpaper"))
        buttonList.add(GuiButton(4, width / 2 + 2, height / 4 + 40 + 25 * 5, 98, 20, "Reset wallpaper"))

        buttonList.add(GuiButton(0, width / 2 - 100, height / 4 + 40 + 25 * 6 + 10, "Back"))
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        mc.fontRendererObj.drawCenteredString("Current: " + if(FDPClient.background == null) { "Customized" } else { "Customized" },
