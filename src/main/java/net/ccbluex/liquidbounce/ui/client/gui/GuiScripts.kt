...
class GuiScripts(private val prevGui: GuiScreen) : GuiScreen() {
    ...
    private inner class GuiList(gui: GuiScreen) :
        ...
        override fun drawSlot(id: Int, x: Int, y: Int, var4: Int, var5: Int, var6: Int) {
            ...
            Fonts.font40.drawCenteredStringWithShadow("§9" + script.scriptName + " §7v" + script.scriptVersion, width / 2f, y + 2f, Color.LIGHT_GRAY.rgb)
            Fonts.font40.drawCenteredStringWithShadow("by §c" + script.scriptAuthors.joinToString(", "), width / 2f, y + 15f, Color.LIGHT_GRAY.rgb).coerceAtLeast(x)
        }
