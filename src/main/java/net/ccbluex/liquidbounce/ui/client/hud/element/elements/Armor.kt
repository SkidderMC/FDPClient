    ...
    fun drawElement(): Border? {
        ...
        if (mc.playerController.isNotCreative) {
            ...
            for (index in 3 downTo 0) {
                ...
                RenderUtils.brawRect(x.toFloat(),25f,x.toFloat() + 18f,26f,Color(140,140,140,220).rgb)
                RenderUtils.brawRect(x.toFloat(),25f,x.toFloat() + (18f * (stack.maxDamage - stack.itemDamage) / stack.maxDamage),26f,colorall)
