...
public class GreyStyle extends Style {
    ...
    public void drawModuleElement(int mouseX, int mouseY, ModuleElement moduleElement) {
        ...
        if(!moduleValues.isEmpty()) {
            Fonts.fontSFUI35.drawStringWithShadow(">", moduleElement.getX() + moduleElement.getWidth() - 8, moduleElement.getY() + 5, RenderUtils.getRainbowOpaque(0, 0.9f, 1.0f, 1));
            ...
            if(moduleElement.isShowSettings()) {
                ...
                for(final Value value : moduleValues) {
                    if(value instanceof BoolValue) {
                        ...
                        final String text = value.getName() + "§f: " + round(floatValue.get()) + floatValue;
                        final float textWidth = Fonts.fontSFUI35.getStringWidth(text);
