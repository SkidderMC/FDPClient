...
public class QuitButton extends ImageButton {
	...
	public void drawButton(int mouseX, int mouseY) {
		...
		RenderUtils.drawRounded(this.x - 1, this.y - 1, this.width + 2, this.height + 2, 2, new Color(30, 30, 30, 60));
		RenderUtils.drawRounded(this.x, this.y, this.width, this.height, 2, new Color(255, 255 - hoverFade * 4, 255 - hoverFade * 4, 38 + hoverFade));
	...
	protected void drawHoverEffect() {
		int w = (int) (Fonts.font32.getStringWidth(this.text));
		RenderUtils.drawRound(this.x + (this.width - w) / 2, this.y + 17, w, 7, 2, new Color(0, 0, 0, 126));
		Fonts.font28.drawCenteredTextScaled(this.text, this.x + this.width / 2, this.y + 18, new Color(255, 255, 255, 135).getRGB(), 0.9F);
	}
