...
public class GuiMainMenu extends GuiScreen implements  GuiYesNoCallback {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        FontLoaders.Roboto.drawString(FDPClient.CLIENT_NAME + "(" + GitUtils.gitBranch + "/" + GitUtils.gitInfo.getProperty("git.commit.id.abbrev") + ") | Minecraft 1.8.9", 7, this.height - 11, new Color(255, 255, 255, 100).getRGB());
        FontLoaders.Roboto.drawString(s, this.width - FontLoaders.Roboto.getStringWidth(s) - 6, this.height - 11, new Color(255, 255, 255, 100).getRGB());
    }
