    ...
    fun drawNotification(
        ...
        if(style.equals("Intellij")) {
                ...
                if(nTypeError){
                    ...
                    FontLoaders.M12.DisplayFont2(FontLoaders.M12,title, -x - 4, -25F, Color(249,130,108).rgb, true)
                }
                if(nTypeInfo) {
                    ...
                    FontLoaders.M12.DisplayFont2(FontLoaders.M12,title, -x - 4, -25F, Color(119,145,147).rgb, true)
                }
                if(nTypeSuccess){
                    ...
                    FontLoaders.M12.DisplayFont2(FontLoaders.M12,title, -x - 4, -25F, Color(10,142,2).rgb, true)
                }
                if(nTypeWarning){
                    ...
                    FontLoaders.M12.DisplayFont2(FontLoaders.M12,title, -x - 4, -25F, Color(175,163,0).rgb, true)
                }
                ...
                FontLoaders.M12.DisplayFont2(FontLoaders.M12,content, -x - 4, -13F, -1, true)
                return false
        } 
    return false
    }
