...
class KeyBindManager : GuiScreen() {
    ...
    override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
        ...
        GL11.glPushMatrix()
        RenderUtils.drawText("%ui.keybind.title%", Fonts.font20, (width * 0.21).toInt(), (height * 0.2).toInt(), 2f, Color.WHITE.rgb, false)
        GL11.glTranslatef(width*0.2f,height * 0.2f + Fonts.font20.height * 2.3f,0F)
        ...
        if (Mouse.hasWheel()) {
            ...
            if(wheel!=0) { //没滚轮，只是正常鼠标移动
                if (popUI != null) {
                    ...
                    val scaledMouseY = (mouseY - (height * 0.2f + Fonts.font20.height * 2.3f)) / scale
