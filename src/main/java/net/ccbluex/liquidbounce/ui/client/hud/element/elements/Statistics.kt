...
class Statistics(
    ...
    override fun drawElement(partialTicks: Float): Border {
        ...
        RenderUtils.drawRoundedCornerRect(0f, 0f, 140f, height, 4f, Color(20, 20, 20, 130).rgb)

        FontLoaders.F22.drawCenteredString("Statistics", (140f / 2f).toDouble(), 5.0, Color(255,255,255,180).rgb)
        ...
        // Player name
        FontLoaders.C16.drawString("Player Name", 5.0F, 0.0F, Color(255,255,255,180).rgb)
        FontLoaders.C16.drawString(mc.thePlayer.name, 135F - FontLoaders.C16.getStringWidth(mc.thePlayer.name), 0.0f, Color(255,255,255,180).rgb)

        // Play time
        FontLoaders.C16.drawString("Play Time", 5.0F, 10.0F, Color(255,255,255,180).rgb)
        ...
        // Kills
        FontLoaders.C16.drawString("Kills", 5.0F, 20.0F, Color(255,255,255,180).rgb)
        ...
        // Deaths
        FontLoaders.C16.drawString("Deaths", 5.0F, 30.0F, Color(255,255,255,180).rgb)
