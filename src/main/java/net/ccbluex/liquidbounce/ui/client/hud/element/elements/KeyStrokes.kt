...
class KeyStrokes : Element(5.0, 25.0, 1.5F, Side.default()) {
    ...
    override fun drawElement(partialTicks: Float): Border {
        ...
        if(keyStyleValue.get().equals("Juul")) {
            ...
            RenderUtils.drawRoundedCornerRect(0f, 32f, 23f, 47f, 5f, if (mc.gameSettings.keyBindAttack.isKeyDown) { Color(65, 65, 75, 255).rgb } else { Color(95, 95, 105, 255).rgb } )
            RenderUtils.drawRoundedCornerRect(24f, 32f, 47f, 47f, 5f, if (mc.gameSettings.keyBindUseItem.isKeyDown) { Color(65, 65, 75, 255).rgb } else { Color(95, 95, 105, 255).rgb } )
...
class KeyStroke(val key: KeyBinding, val posX: Int, val posY: Int, val width: Int, val height: Int) {
    ...
    if(style.equals("Juul")) {
        ...
        RenderUtils.drawRoundedCornerRect(0F, 0F, width.toFloat(), height.toFloat(), 5f, rectColor.rgb)
        lastClick = key.isKeyDown
