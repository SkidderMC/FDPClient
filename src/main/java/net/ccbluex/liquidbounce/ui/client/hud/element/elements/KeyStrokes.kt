...
class KeyStrokes : Element(5.0, 25.0, 1.5F, Side.default()) {
    ...
    override fun drawElement(partialTicks: Float): Border {
        ...
        if(keyStyleValue.get().equals("Juul")) {
            ...
            Fonts.font35.drawString(juulLeft, 11.5 - (font.getStringWidth(juulLeft) / 2) + 1, 39.5 - (font.FONT_HEIGHT / 2) + 2, textColor.rgb)
            Fonts.font35.drawString(juulRight, 35.5 - (font.getStringWidth(juulRight) / 2) + 1, 39.5 - (font.FONT_HEIGHT / 2) + 2, textColor.rgb)
/*   
