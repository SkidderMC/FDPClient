    ...
    public void handle(int mouseX, int mouseY, int button, GuiEvents type) {
        ...
        double count = 0;
            ...
            if (setting instanceof FloatValue) {
                ...
                RenderUtils.drawCustomShapeWithRadius(x + 5, sliderY, totalSliderWidth, 3, 1.5f, DrRenderUtils.applyOpacity(darkRectHover, (float) (.4f + (.2 * hoverAnimation.getOutput()))));
                RenderUtils.drawCustomShapeWithRadius(x + 5, sliderY, Math.max(4, sliderfloatMap.get(numberSetting)), 3, 1.5f, accent ? accentedColor2 : textColor);
            ...
            if (setting instanceof IntegerValue) {
                ...
                float sliderY = (settingY + 18);
                RenderUtils.drawCustomShapeWithRadius(x + 5, sliderY, totalSliderWidth, 3, 1.5f, DrRenderUtils.applyOpacity(darkRectHover, (float) (.4f + (.2 * hoverAnimation.getOutput()))));
                RenderUtils.drawCustomShapeWithRadius(x + 5, sliderY, Math.max(4, sliderintMap.get(numberSetting)), 3, 1.5f, accent ? accentedColor2 : textColor);
            ...
            if (setting instanceof NumberValue) {
                ...
                String value = Float.toString((float) MathExtensionsKt.round(numberSetting.getValue(), numberSetting.getInc()));
                float regularFontWidth = (float) Fonts.SF.SF_18.SF_18.stringWidth(numberSetting.getName() + ": ");
                float valueFontWidth = (float) Fonts.SF.SF_18.SF_18.stringWidth(value);
                ...
                float sliderY = (settingY + 18);
                RenderUtils.drawCustomShapeWithRadius(x + 5, sliderY, totalSliderWidth, 3, 1.5f, DrRenderUtils.applyOpacity(darkRectHover, (float) (.4f + (.2 * hoverAnimation.getOutput()))));
                RenderUtils.drawCustomShapeWithRadius(x + 5, sliderY, Math.max(4, sliderMap.get(numberSetting)), 3, 1.5f, accent ? accentedColor2 : textColor);
            ...
            if (setting instanceof BoolValue) {
                ...
                Fonts.SF.SF_18.SF_18.drawString(booleanSetting.getName(), (int) MathExtensionsKt.roundToHalf(x + 4), settingY +
                        5, textColor.getRGB());
                ...
                RenderUtils.drawCustomShapeWithRadius(x + width - (switchWidth + 5.5f), settingY + Fonts.SF.SF_18.SF_18.getMiddleOfBox(rectHeight) + 2, switchWidth, 4.5f,
                ...
                RenderUtils.drawCustomShapeWithRadius((float) (x + width - (switchWidth + 6) + ((switchWidth - 5) * toggleAnimation.getOutput())),
            ...
            if (setting instanceof ListValue) {
                ...
                RenderUtils.drawCustomShapeWithRadius(x + 5, (float) (settingY + rectHeight + 2 + (12 * openAnimation.getOutput())),
                ...
                for (String mode : modeSetting.getValues()) {
                    ...
                    if (modeHoverAnimation.finished(Direction.FORWARDS) || !modeHoverAnimation.isDone()) {
                        RenderUtils.drawCustomShapeWithRadius(x + 5, modeY - 5, width - 10, rectHeight, 3,
                ...
                RenderUtils.drawCustomShapeWithRadius(x + 5, settingY + 5, width - 10, rectHeight + 7, 3, DrRenderUtils.applyOpacity(darkRectHover, .45f));

                if(!hoverAnimation.isDone() || hoverAnimation.finished(Direction.FORWARDS)) {
                    RenderUtils.drawCustomShapeWithRadius(x + 5, settingY + 5, width - 10, rectHeight + 7, 3, DrRenderUtils.applyOpacity(textColor, (float) (.2f * hoverAnimation.getOutput())));
                }
                ...
                if (openAnimation.isDone() && openAnimation.getDirection().equals(Direction.FORWARDS) || !openAnimation.isDone()) {
                    ...
                    RenderUtils.drawCustomShapeWithRadius(x + 5 + ((width - 10) / 2f - selectRectWidth / 2f), settingY + rectHeight + 10.5f,
