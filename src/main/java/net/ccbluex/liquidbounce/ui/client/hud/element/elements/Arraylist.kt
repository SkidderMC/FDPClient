        ...
        when (side.horizontal) {
            Horizontal.RIGHT, Horizontal.MIDDLE -> {
                modules.forEachIndexed { index, module ->
                    ...
                    if (jelloShadow){RenderUtils.drawImage(ResourceLocation("fdpclient/ui/shadow/shadow.png"), xPos.toInt() - 43 - if (rectMode.equals("right", true)) 3f else 0f, yPos.toInt() + textY.toInt() - 18.5f, 87, 37, 254f )}
