            ...
            Horizontal.RIGHT, Horizontal.MIDDLE -> {
                    ...
                    ShadowUtils.shadow(shadowStrength.get().toFloat(), {
                        ...
                        modules.forEachIndexed { index, module ->
                            ...
                            RenderUtils.newDrawRect(xPos.toDouble() - if (rectValue.get().equals("right", true)) 3 else 2, arrayY, if (rectValue.get().equals("right", true)) -1f.toDouble() else 0, arrayY + textHeight,
