        ...
        when (side.horizontal) {
            Horizontal.RIGHT, Horizontal.MIDDLE -> {
                modules.forEachIndexed { index, module ->
                    ...
                    if (jelloShadow){RenderUtils.drawImage2(ResourceLocation("fdpclient/ui/shadow/shadow.png"), xPos - if (rectMode.equals("right", true)) 3 else 0, yPos + textY - 18.5, 87, 37 )}
