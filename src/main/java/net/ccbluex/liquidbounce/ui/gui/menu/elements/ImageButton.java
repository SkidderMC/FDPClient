...
public class ImageButton extends GuiButton {
    ...
    protected void drawHoverEffect() {
        int w = (int) (Fonts.font32.getStringWidth(this.text) * 0.9F);
        RenderUtils.drawRound(this.x + (this.width - w) / 2, this.y - 12, w, 7, 2, new Color(0, 0, 0, 126));
        Fonts.font32.drawCenteredTextScaled(this.text, this.x + this.width / 2, this.y - 11, new Color(255, 255, 255, 135).getRGB(), 0.9F);
    }
