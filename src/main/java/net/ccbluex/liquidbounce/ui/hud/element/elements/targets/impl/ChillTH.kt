...
import net.ccbluex.liquidbounce.ui.hud.element.elements.targets.utils.CharRenderer
...
class ChillTH(inst: Targets) : TargetStyle("Chill", inst, true) {
    ...
    override fun drawTarget(entity: EntityLivingBase) {
        ...
        if (playerInfo != null) {
            ...
            Stencil.erase(true)
            drawHead(playerInfo.locationSkin, 4, 4, 30, 30, (1F - targetInstance.getFadeProgress()).toInt())
            Stencil.dispose()
        }
