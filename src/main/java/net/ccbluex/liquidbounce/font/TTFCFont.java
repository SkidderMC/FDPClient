...
/* loaded from: LiquidBounce-b73.jar:net/ccbluex/liquidbounce/TTFCFont.class */
public class TTFCFont {
    protected Font font;
    ...
    public TTFCFont(Font font, boolean antiAlias, boolean fractionalMetrics) {
        this.font = font;
    ...
    /* loaded from: LiquidBounce-b73.jar:net/ccbluex/liquidbounce/TTFCFont$CharData.class */
