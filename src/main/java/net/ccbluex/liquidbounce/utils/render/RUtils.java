...
import net.ccbluex.liquidbounce.utils.R2TUtil;
...
public final class RUtils extends MinecraftInstance {
    ...
    public static void skeetRect(final double x, final double y, final double x1, final double y1, final double size) {
        RUtils.rectangleBordered(x, y + -4.0, x1 + size, y1 + size, 0.5, new Color(60, 60, 60).getRGB(), new Color(10, 10, 10).getRGB());
        RUtils.rectangleBordered(x + 1.0, y + -3.0, x1 + size - 1.0, y1 + size - 1.0, 1.0, new Color(40, 40, 40).getRGB(), new Color(40, 40, 40).getRGB());
        RUtils.rectangleBordered(x + 2.5, y + -1.5, x1 + size - 2.5, y1 + size - 2.5, 0.5, new Color(40, 40, 40).getRGB(), new Color(60, 60, 60).getRGB());
        RUtils.rectangleBordered(x + 2.5, y + -1.5, x1 + size - 2.5, y1 + size - 2.5, 0.5, new Color(22, 22, 22).getRGB(), new Color(255, 255, 255, 0).getRGB());
    }

    public static void skeetRectSmall(final double x, final double y, final double x1, final double y1, final double size) {
        RUtils.rectangleBordered(x + 4.35, y + 0.5, x1 + size - 84.5, y1 + size - 4.35, 0.5, new Color(48, 48, 48).getRGB(), new Color(10, 10, 10).getRGB());
        RUtils.rectangleBordered(x + 5.0, y + 1.0, x1 + size - 85.0, y1 + size - 5.0, 0.5, new Color(17, 17, 17).getRGB(), new Color(255, 255, 255, 0).getRGB());
    }
    ...
    public static void renderEnchantText(ItemStack stack, int x, float y) {
        ...
        if (stack.getItem() instanceof ItemArmor) {
            ...
            if (protectionLevel > 0) {
                RUtils.drawEnchantTag("P" + COL0rs.getColor(protectionLevel) + protectionLevel, x * 2, enchantmentY);
                enchantmentY += 8;
            }
            if (unbreakingLevel > 0) {
                RUtils.drawEnchantTag("U" + COL0rs.getColor(unbreakingLevel) + unbreakingLevel, x * 2, enchantmentY);
                enchantmentY += 8;
            }
            if (thornLevel > 0) {
                RUtils.drawEnchantTag("T" + COL0rs.getColor(thornLevel) + thornLevel, x * 2, enchantmentY);
                enchantmentY += 8;
            }
        }
        if (stack.getItem() instanceof ItemBow) {
            ...
            int unbreakingLevel = EnchantmentHelper.getEnchantmentLevel(Enchantment.unbreaking.effectId, stack);
            if (powerLevel > 0) {
                RUtils.drawEnchantTag("Pow" + COL0rs.getColor(powerLevel) + powerLevel, x * 2, enchantmentY);
                enchantmentY += 8;
            }
            if (punchLevel > 0) {
                RUtils.drawEnchantTag("Pun" + COL0rs.getColor(punchLevel) + punchLevel, x * 2, enchantmentY);
                enchantmentY += 8;
            }
            if (flameLevel > 0) {
                RUtils.drawEnchantTag("F" + COL0rs.getColor(flameLevel) + flameLevel, x * 2, enchantmentY);
                enchantmentY += 8;
            }
            if (unbreakingLevel > 0) {
                RUtils.drawEnchantTag("U" + COL0rs.getColor(unbreakingLevel) + unbreakingLevel, x * 2, enchantmentY);
        ...
        if (stack.getItem() instanceof ItemSword) {
            ...
            int unbreakingLevel = EnchantmentHelper.getEnchantmentLevel(Enchantment.unbreaking.effectId, stack);
            if (sharpnessLevel > 0) {
                RUtils.drawEnchantTag("S" +  COL0rs.getColor(sharpnessLevel) + sharpnessLevel, x * 2, enchantmentY);
                enchantmentY += 8;
            }
            if (knockbackLevel > 0) {
                RUtils.drawEnchantTag("K" + COL0rs.getColor(knockbackLevel) + knockbackLevel, x * 2, enchantmentY);
                enchantmentY += 8;
            }
            if (fireAspectLevel > 0) {
                RUtils.drawEnchantTag("F" + COL0rs.getColor(fireAspectLevel) + fireAspectLevel, x * 2, enchantmentY);
                enchantmentY += 8;
            }
            if (unbreakingLevel > 0) {
                RUtils.drawEnchantTag("U" + COL0rs.getColor(unbreakingLevel) + unbreakingLevel, x * 2, enchantmentY);
    ...
    public static void drawOutlinedStringCock(FontRenderer fr, String s, float x, float y, int color, int outlineColor) {
        fr.drawString(COLUtil.stripColor(s), (int) (x - 1.0f), (int) y, outlineColor);
        fr.drawString(COLUtil.stripColor(s), (int) x, (int) (y - 1.0f), outlineColor);
        fr.drawString(COLUtil.stripColor(s), (int) (x + 1.0f), (int) y, outlineColor);
        fr.drawString(COLUtil.stripColor(s), (int) x, (int) (y + 1.0f), outlineColor);
        ...
        try {
            for (final Particle particle : particles) {
                ...
                if (draw) {
                    ...
                    final Color c = new Color(COLUtil.getColor(-(1 + 5 * 1.7f), 0.7f, 1));
    ...
    public static void drawRoundedRect(float x, float y, float width, float height, float edgeRadius, int color, float borderWidth, int borderColor) {
        if (color == 16777215) color = COL0rs.WHITE.c;
        if (borderColor == 16777215) borderColor = COL0rs.WHITE.c;
        ...
        enableRender2D();
        net.ccbluex.liquidbounce.utils.R2TUtil.color(color);
        GL11.glBegin(6);
        ...
        GL11.glEnd();
        net.ccbluex.liquidbounce.utils.R2TUtil.color(borderColor);
    ...
    public static void drawImage(ResourceLocation image, double x, double y, double width, double height, int color) {
        ...
        RUtils.drawModalRectWithCustomSizedTexture((float)x, (float)y, 0.0f, 0.0f, (float)width, (float)height, (float)width, (float)height);
        GL11.glDepthMask(true);
        GL11.glDisable(3042);
        GL11.glEnable(2929);
        GlStateManager.popMatrix();
    ...
    public static void drawTexturedRect(float x, float y, float width, float height, String image) {
        ...
        RUtils.drawModalRectWithCustomSizedTexture(x, y, 0, 0, width, height, width, height);
    ...
    public static void drawTexturedRect(float x, float y, float width, float height, String image, ScaledResolution sr) {
        ...
        GlStateManager.enableBlend();
        GlStateManager.disableAlpha();
        mc.getTextureManager().bindTexture(new ResourceLocation("liquidbounce/" + image + ".png"));
    ...
    public static void rectangleBordered(double x, double y, double x1, double y1, double width, int internalColor,
                                         int borderColor) {
        RUtils.rectangle(x + width, y + width, x1 - width, y1 - width, internalColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        RUtils.rectangle(x + width, y, x1 - width, y + width, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        RUtils.rectangle(x, y, x + width, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        RUtils.rectangle(x1 - width, y, x1, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
        RUtils.rectangle(x + width, y1 - width, x1 - width, y1, borderColor);
        GlStateManager.color((float) 1.0f, (float) 1.0f, (float) 1.0f, (float) 1.0f);
    }
    public static void Gamesense(double x, double y, double x1, double y1, double size , float color1, float color2 , float color3) {
        RUtils.rectangleBordered(x, y, x1 + size, y1 + size, 0.5d, Colors2.getColor(90), Colors2.getColor(0));
        RUtils.rectangleBordered(x + 1.0f, y + 1.0f, (x1 + size - 1.0f), y1 + size - 1.0f, 1.0, Colors2.getColor(90),
                Colors2.getColor(61));
        RUtils.rectangleBordered(x + 2.5, y + 2.5, (x1 + size) - 2.5, (y1 + size) - 2.5, 0.5, Colors2.getColor(61),
                Colors2.getColor(0));
        RUtils.drawGradientSideways(x + size * 3, (y + 3.0f), x1 -  size * 2, y + 4, (int) color2, (int) color3);
    }
    ...
    public static void autoExhibition(double x, double y, double x1, double y1, double size) {
        rectangleBordered(x, y, x1 + size, y1 + size, 0.5, COL0rs.getColor(90), COL0rs.getColor(0));
        rectangleBordered(x + 1.0, y + 1.0, x1 + size - 1.0, y1 + size - 1.0, 1.0, COL0rs.getColor(90), COL0rs.getColor(61));
        rectangleBordered(x + 2.5, y + 2.5, x1 + size - 2.5, y1 + size - 2.5, 0.5, COL0rs.getColor(61), COL0rs.getColor(0));
    }
