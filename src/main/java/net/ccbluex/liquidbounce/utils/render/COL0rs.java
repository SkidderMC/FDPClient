...
public enum COL0rs {
    ...
    public static Color getHealthColor(EntityLivingBase entityLivingBase) {
        ...
        Color[] COL0rs = new Color[]{new Color(133, 0, 0), Color.RED, Color.ORANGE, Color.YELLOW, Color.GREEN};
        float progress = health / entityLivingBase.getMaxHealth();
        return health >= 0.0F?blendColors(fractions, COL0rs, progress).brighter():COL0rs[0];
    }
