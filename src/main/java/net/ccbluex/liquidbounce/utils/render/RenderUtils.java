...
public final class RenderUtils extends MinecraftInstance {
    ...
    public static void drawRoundOutline(int x, int y, int x2, int y2, float radius, float width, int color) {
    ...
    public static void drawRoundOutline(float x, float y, float x2, float y2, float radius, float width) {
        int i = 18;
        int j = 90 / i;
        ...
        for (k = 0; k <= i; k++) {
            int m = 90 - k * j;
            GL11.glVertex2f((float) (f1 + radius * MathUtils.INSTANCE.getRightAngle(m)), (float) (f2 - radius * MathUtils.INSTANCE.getAngle(m)));
        }
        GL11.glEnd();
        f1 = x2 - radius;
        f2 = y2 - radius;
    ...
    public static void drawRounded(int x, int y, int width, int height, int cornerRadius, Color color) {
