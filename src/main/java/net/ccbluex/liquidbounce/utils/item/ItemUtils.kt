...
object ItemUtils {
    ...
    fun getWeaponEnchantFactor(stack: ItemStack, nbtedPriority: Float = 0f, goal: EnumNBTPriorityType = EnumNBTPriorityType.NONE):Double{
    ...
    fun compareArmor(o1: ArmorPiece, o2: ArmorPiece, nbtedPriority: Float = 0f, goal: EnumNBTPriorityType = EnumNBTPriorityType.NONE): Int {
