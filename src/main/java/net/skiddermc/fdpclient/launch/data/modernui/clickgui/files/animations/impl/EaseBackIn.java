package net.skiddermc.fdpclient.launch.data.modernui.clickgui.files.animations.impl;

import net.skiddermc.fdpclient.launch.data.modernui.clickgui.files.animations.Animation;
import net.skiddermc.fdpclient.launch.data.modernui.clickgui.files.animations.Direction;
