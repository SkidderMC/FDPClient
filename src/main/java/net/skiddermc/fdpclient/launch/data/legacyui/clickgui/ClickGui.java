 ...
 */
package net.skiddermc.fdpclient.launch.data.legacyui.clickgui;
...
import net.skiddermc.fdpclient.launch.data.legacyui.clickgui.elements.ButtonElement;
...
import net.skiddermc.fdpclient.launch.data.legacyui.clickgui.style.Style;
import net.skiddermc.fdpclient.launch.data.legacyui.clickgui.style.styles.SlowlyStyle;
...
import net.skiddermc.fdpclient.ui.font.AWTFontRenderer;
...
public class ClickGui extends GuiScreen {
	...
	final double scale = FDPClient.moduleManager.getModule(ClickGUIModule.class).scaleValue.get();
        if (progress < 1) progress += 0.1 * (1 - partialTicks);
        else progress = 1;

        switch (((ClickGUIModule) Objects.requireNonNull(FDPClient.moduleManager.getModule(ClickGUIModule.class))).animationValue.get().toLowerCase()) {
            case "liquidbounce":
            case "ziul":
    ...
    public void onGuiClosed() {
        FDPClient.fileManager.saveConfig(LegacyUiLaunchOption.getClickGuiConfig());
    }
