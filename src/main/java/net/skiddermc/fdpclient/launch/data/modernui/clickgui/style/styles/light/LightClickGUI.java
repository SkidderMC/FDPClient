 ...
 */
package net.skiddermc.fdpclient.launch.data.modernui.clickgui.style.styles.light;

import java.awt.*;
import java.io.IOException;

import net.skiddermc.fdpclient.launch.data.modernui.clickgui.style.styles.light.LightSettings.InputBox;
import net.skiddermc.fdpclient.launch.data.modernui.clickgui.style.styles.light.ModuleSettings.Setting.Settings;
