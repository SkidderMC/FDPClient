 ...
 */
package net.skiddermc.fdpclient.launch.data.modernui.clickgui;
...
import net.skiddermc.fdpclient.launch.data.modernui.clickgui.elements.Element;
import net.skiddermc.fdpclient.launch.data.modernui.clickgui.elements.ModuleElement;
import net.skiddermc.fdpclient.launch.data.modernui.clickgui.style.Style;
import net.skiddermc.fdpclient.launch.data.modernui.clickgui.style.styles.SlowlyStyle;
import net.skiddermc.fdpclient.launch.options.modernuiLaunchOption;
