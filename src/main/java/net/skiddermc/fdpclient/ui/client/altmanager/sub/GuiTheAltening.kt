package net.skiddermc.fdpclient.ui.client.altmanager.sub
...
import net.skiddermc.fdpclient.ui.elements.GuiPasswordField
            ...
            1 -> {
                ...
                asynchronous.accountData.thenAccept { account ->
                    ...
                    try {
                        ...
                        yggdrasilUserAuthentication.setPassword(FDPClient.CLIENT_NAME)
