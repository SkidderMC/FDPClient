...
import net.skiddermc.fdpclient.features.module.modules.player.InventoryCleaner
...
class ChestStealer : Module() {
    ...
    fun onRender3D(event: Render3DEvent) {
        ...
        // inventory cleaner
        val inventoryCleaner = FDPClient.moduleManager[InventoryCleaner::class.java]!!
