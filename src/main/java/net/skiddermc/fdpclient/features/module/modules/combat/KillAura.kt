...
import net.skiddermc.fdpclient.features.module.modules.movement.TargetStrafe
import net.skiddermc.fdpclient.features.module.modules.player.Blink
import net.skiddermc.fdpclient.features.module.modules.render.FreeCam
import net.skiddermc.fdpclient.features.module.modules.world.Scaffold
import net.skiddermc.fdpclient.utils.EntityUtils
import net.skiddermc.fdpclient.utils.MovementUtils
import net.skiddermc.fdpclient.utils.RaycastUtils
...
class KillAura : Module() {
    ...
    // Visuals
    private val markValue = ListValue("Mark", arrayOf("Liquid", "FDP", "Block", "Jello", "Sims", "Circle", "Plat", "None"), "FDP")
