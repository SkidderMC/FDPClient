...
import net.skiddermc.fdpclient.features.macro.Macro
import net.skiddermc.fdpclient.features.module.EnumAutoDisableType
import net.skiddermc.fdpclient.file.configs.*
    ...
    fun loadBackground() {
        if (backgroundFile.exists()) {
            try {
                ...
                FDPClient.background = ResourceLocation(FDPClient.CLIENT_NAME.toLowerCase() + "/background.png")
