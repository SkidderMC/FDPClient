...
var _AdaptedModule = function (module) {
    ...
    this.moduleManager = Java.type("net.skiddermc.fdpclient.FDPClient").moduleManager;
...
var _CommandManager = function () {
    ...
    this.commandManager = Java.type("net.skiddermc.fdpclient.FDPClient").commandManager;
