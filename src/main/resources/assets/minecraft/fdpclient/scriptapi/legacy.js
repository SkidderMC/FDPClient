...
var _AdaptedValue = function (value) {
    ...
    this.FloatValue = Java.type("net.ccbluex.liquidbounce.features.value.FloatValue");
    this.IntegerValue = Java.type("net.ccbluex.liquidbounce.features.value.IntegerValue");
